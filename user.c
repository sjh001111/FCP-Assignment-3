...
void display_users(User users[], int *count)
{
    if (*count)
    {
        printf("   ID 弛 Name               弛 Encrypted password 弛 Encrypted card num \n"
               "  式式式式扛式式式式式式式式式式式式式式式式式式式式扛式式式式式式式式式式式式式式式式式式式式扛式式式式式式式式式式式式式式式式式式式式\n");
...
void debug(User users[], int *count)
{
    ...
    if (*count)
    {
        printf("   ID 弛 Name               弛 Decrypted password 弛 Decrypted card num \n"
               "      弛                    弛 (Caesar Cipher)    弛 (XOR Cipher)       \n"
               "  式式式式扛式式式式式式式式式式式式式式式式式式式式扛式式式式式式式式式式式式式式式式式式式式扛式式式式式式式式式式式式式式式式式式式式\n");
